defmodule PairingProjectWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PairingProjectWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PairingProjectWeb.Gettext, "errors", msg, opts)
    end
  end
